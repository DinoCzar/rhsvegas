(function () {
  ...
  var RENDER_API_ORIGIN = "https://rhsvegas-api.onrender.com";
  // Checkout uses this URL. SMTP must be configured on rhsvegas-api (Render).
  // Verify: https://rhsvegas-api.onrender.com/api/health
